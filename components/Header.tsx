...
const products = [
  {
    name: "Book a Room",
    description: "Book a room on Booking.com",
    href: "#",
    icon: HomeIcon,
  },
  {
  ...
  },
  {
    ...
    description: "Get assistance with your booking.",
    href: "#",
    ...
    <header className="bg-[#013B94]">
      ...
      >
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          {/* TODO: refactor as an array and map over */}
...
{/* TODO: refactor as separate component */}
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              ...
              <div className="py-6">
                <div className="-mx-3 block rounded-lg py-2.5 px-3 text-base font-semibold leading-7 text-white hover:bg-gray-50">
                  Log in
                </div>
              </div>
            </div>
